# Melt rules (Liquid Gold)

1. Recognize gold (principles, Diátaxis, checklists, orchestration ideas).
...
10. Em dashes are optional (Diego voice). Fail indiscriminate stacking, not the mark.
